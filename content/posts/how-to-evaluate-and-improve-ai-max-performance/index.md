...
In Google Ads, [AI Max](https://chloevolution.com/posts/what-is-google-ai-max/) is not a separate campaign type but a set of AI enhancements embedded within existing search ads. As a result, the methods for viewing data and analyzing performance are integrated into your Search campaign reports.
...
* **AI Max expanded matches**: New matching keywords generated by AI based on your existing keywords—understanding [AI vs. manual keyword matching](https://chloevolution.com/posts/ai-max-search-keyword-insights/) helps optimize this process
...
* Allows analysis of performance metrics for AI-generated copy—be aware of [key risks when using AI Max for ad copy](https://chloevolution.com/posts/ai-max-ad-creative-insights/)
